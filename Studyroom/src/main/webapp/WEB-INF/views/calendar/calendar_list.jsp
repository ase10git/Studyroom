...
<body>
    ...
    <h1 align="center" id="calendarTitle">${currentYear}년 ${currentMonth}월</h1>
    <div class="calBtn">
    <button name="calPrev" onclick="calPrev(${currentYear}, ${currentMonth})">&lt</button>
    <button name="calNext" onclick="calNext(${currentYear}, ${currentMonth})">&gt</button>
    </div>
