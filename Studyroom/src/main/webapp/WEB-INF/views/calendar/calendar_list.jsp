                ...
                if (date > 0 && date <= lastDate.getDate()) { //날짜가 해당달에 속해잉ㅆ는겨웅
                    ...
                    ***REMOVED***);
                    ...
                    dateEvents.forEach(function(e) {
                    	 html += '<p style="margin-bottom:5px;">' + typeNames[e.type] + '</p>';
                    ***REMOVED***);
                    html += '</td>';
                ***REMOVED*** else {
        ...
        ***REMOVED***);
        ...
        dateEvents.forEach(function(e, i) {
            ...
            if (e.type != 'course_schedule') { // 강의 일정 이 아닌 경우에만 버튼 표시
                ...
                html += ' <button id="edit-button-' + i + '">수정</button></p><hr>';  // '수정' 버튼 추가
            ***REMOVED***
        ***REMOVED***);
		//일정 정보를 모달에 표시
...
<body>
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body" style="text-align: center;">
	                <form id="event-form">
	                    <select id="event-type" style="text-align: left; vertical-align: top;">
	        ...
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                <form id="edit-event-form">
	                    <select id="edit-event-type" style="text-align: left; vertical-align: top;">
	                        <option value="personal_event">개인 일정</option>
	                        <option value="note">노트</option>
	                    </select>
	...
	<div style="margin: 200px;">footer있는척</div>
