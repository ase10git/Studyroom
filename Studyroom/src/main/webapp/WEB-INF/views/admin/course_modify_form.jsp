...
<!-- 						<caption>:::코스 수정하기:::</caption> -->
						...
						<tr>
							<th>코스 시작일</th>
							<td><input name="start_date" type="date" value="${fn:split(dto.start_date, ' ')[0]***REMOVED***"></td>
						</tr>
						<tr>
							<th>코스 종료일</th>
							<td><input name="end_date" type="date" value="${fn:split(dto.end_date, ' ')[0]***REMOVED***"></td>
						</tr>
						<tr>
							<td>
