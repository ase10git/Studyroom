	          ...
	          <div class="row gy-4 ">
	            <div class="col box col-12 d-flex justify-content-center">
	                <table>
	                    ...
	                    <c:forEach var="user_dto" items="${user_list***REMOVED***">
		                    <tr>
	                            <td><input class="user-check" type="checkbox" name="userId" value="${user_dto.id***REMOVED***"></td>
	                            <td><span>${user_dto.id***REMOVED***</span></td>
	                            <td><span>${user_dto.email***REMOVED***</span></td>
	                            <td><span>${user_dto.username***REMOVED***</span></td>
	                            <td><span>${user_dto.role***REMOVED***</span></td>
		                    </tr>
	                    </c:forEach>
	                </table>
	            </div>
	            ...
	            <div class="col box col-12 d-flex justify-content-center">
	                <table>
	                	...
	                	<c:forEach var="course_dto" items="${course_list***REMOVED***">
		                    <tr>
	                            <td><input class="course-check" type="checkbox" name="courseId" value="${course_dto.id***REMOVED***"></td>
	            ...
	            <div class="col box col-12 d-flex justify-content-center">
	                <table>
	                	...
	                	<c:forEach var="course_board_dto" items="${course_board_list***REMOVED***">
		                    <tr>
	                            <td><input class="courseboard-check" type="checkbox" name="courseboardId" value="${course_board_dto.id***REMOVED***"></td>
	          ...
	          <div class="row gy-4">
	            <div class="col box col-12 d-flex justify-content-center">
	                <table>
	                    ...
	                    <c:forEach var="community_dto" items="${community_list***REMOVED***">
		                    <tr>
	                            <td><input class="community-check" type="checkbox" name="communityId" value="${community_dto.id***REMOVED***"></td>
	                            <td><span>${community_dto.id***REMOVED***</span></td>
	                            <td><span>${community_dto.user_id***REMOVED***</span></td>
	                            <td><span>${community_dto.ip_addr***REMOVED***</span>
	                            <td><span>${fn:split(community_dto.register_date, " ")[0]***REMOVED***</span></td>
		                    </tr>
	                    </c:forEach>
	                </table>
	            </div>
