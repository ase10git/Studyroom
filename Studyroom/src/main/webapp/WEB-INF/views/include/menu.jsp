...
<body>
	<div class="menu">
		<ul class="menu-bar">
			...
			<li class="user-info"><a href='user_view?id=${sessionScope.dto.id}' class="btn btn-primary"><span class="nanum-gothic-regular">${sessionScope.dto.username}</span></a></li>
			<li class="course"><a href='course_list?id=${sessionScope.dto.id}' class="btn btn-primary"><span class="nanum-gothic-regular">코스</span></a></li>
