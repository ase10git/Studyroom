...
<body>
	<div class="menu">
		<ul class="menu-bar">
			...
			<li><a href='user_view?id=${dto.id***REMOVED***' class="item user-info"><i class="fi fi-ss-user"></i><span>${sessionScope.dto.username***REMOVED***</span></a></li>
			...
			<li><input type="button" class="btn btn-primary" id="logout" value="로그아웃" onclick="logout()"></li>
		</ul>
	</div>
</body>
</html>