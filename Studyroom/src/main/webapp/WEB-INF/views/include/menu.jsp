...
<body>
	<div class="menu">
		<ul class="menu-bar">
			...
			<li><a href='user_view?id=${sessionScope.dto.id***REMOVED***' class="item user-info"><i class="fi fi-ss-user"></i><span>${sessionScope.dto.username***REMOVED***</span></a></li>
			<li><a href='course_list?id=${sessionScope.dto.id***REMOVED***' class="item course"><i class="fi fi-ss-book"></i><span>코스</span></a></li>
