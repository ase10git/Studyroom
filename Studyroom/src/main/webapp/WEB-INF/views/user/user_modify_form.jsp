			...
			<div class="box col-12">
				<form action="user_modify" name="f" method="post">
					...
					<table>
						<tr>
							<th>이름</th>
							<td><input name="username" class="form-control" value="${dto.username}" placeholder="이름 입력"></td>
						</tr>
						<tr>
							<th>이메일</th>
							<td><input name="email" class="form-control" value="${dto.email}" readonly></td>
						</tr>
						<tr>
							<th>전화번호</th>
							<td><input name="tel" class="form-control" value="${dto.tel}" placeholder="전화번호 입력"></td>
						</tr>
						<tr>
							<th>비밀번호</th>
